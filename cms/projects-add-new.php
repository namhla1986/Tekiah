...
$sql_selectedproject = "SELECT pid, ptitle FROM tblprojects";
...
<div id="body_column_right_container">
    ...
    <div id="body_column_right">
        <h2><?php echo $rs_selectedproject_rows['ptitle']; ?></h2>
        <p>&nbsp;</p>
        <table cellspacing="0" class="tbldatadisplay">
        <tr>
        <td>
        <form method="post" action="projects-add-new-process.php"enctype="multipart/form-data">

        	<select  name="txtprojects">
        <?php do { ?>
            	<option value="<?php echo $rs_selectedproject_rows['pid']; ?>"><?php echo $rs_selectedproject_rows['ptitle']; ?></option>
